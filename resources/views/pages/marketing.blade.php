...
@section('content')
    ...
    <div id="page" class="site">
        ...
        <main id="primary" class="site-main">
            ...
            <article id="post-22734" class="post-22734 page type-page status-publish has-post-thumbnail hentry">

                <header id="hero" class="hero hero-type__content hero-template__service"
                        style="background-image: url('../../wp-content/uploads/2022/04/sms-hero-offset-v2.jpg');">
                    <div class="hero-overlay"></div>
                    <div class="container above-overlay" id="gf_3">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1>Hire a Professional Digital Marketing Assistant with {{ env('APP_NAME') }}.</h1>
                                <h5 class="secondary"></h5>
                                <p></p>
                                <a class="btn" id="hero-cta-btn"
                                   href="{{ route('get_started') }}"><span>Hire {{ env('APP_NAME') }}</span></a>
                            </div>
                        </div>
                        <div class="row hero-columns-below">
                            <div class="col-sm-12 col-md-4 col-lg-4 hero-column">
                                <p class="icon text-center"><i class="fa-thin fa-location-dot"></i></p>
                                ...
                                <h3 style="font-family: Roboto Condensed, Arial Narrow, sans-serif; color: #ffffff; font-size: 14pt; text-align: center; letter-spacing: 0.2em; font-weight: 700;">
                                    U.S.-BASED</h3>
                                <p class="text-center">We search the entire country for a Digital Marketing Assistant to
                                    find the right person for your organization.</p>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 hero-column">
                                <p class="icon text-center"><i class="fa-thin fa-magnifying-glass"></i></p>
                                <h4 class="text-center"></h4>
                                <h3 style="font-family: Roboto Condensed, Arial Narrow, sans-serif; color: #ffffff; font-size: 14pt; text-align: center; letter-spacing: 0.2em; font-weight: 700;">
                                    HIGHLY VETTED</h3>
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4 hero-column">
                                ...
                                <h3 style="font-family: Roboto Condensed, Arial Narrow, sans-serif; color: #ffffff; font-size: 14pt; text-align: center; letter-spacing: 0.2em; font-weight: 700;">
                                    AI-EMPOWERED</h3>
                                <p class="text-center">Our AI-empowered Marketing Assistants streamline content, manage
                                    campaigns, and stay competitive with smarter, faster support powered by today’s
                                    leading
                                    tools.</p>
                            </div>
                        </div>
    ...
    <div class="entry-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p class="u-fade-type-static js-scroll-trigger is-active">Are you struggling to promptly respond
                            to direct messages and comments? Do you find yourself overwhelmed and unable to effectively
                            engage with your audience?</p></div>
                    <div class="col-lg-4">
                        <i class="fa-thin fa-circle-question"></i>
                        <h3>Expertise</h3>
                        <p class="u-fade-type-static js-scroll-trigger is-active">Are you daunted by the need to keep up
                            with the latest marketing best practices, and worry that your strategies might be falling
                            behind?</p></div>
                    <div class="col-lg-4">
                        <i class="fa-thin fa-clock"></i>
                        <h3>Lack of Time</h3>
                        <p class="u-fade-type-static js-scroll-trigger is-active">Do you find it difficult to find time
                            to manage — or even start — email marketing campaigns, causing you to miss out on invaluable
                            engagement and sales opportunities?</p></div>
                </div>
            ...
            <div class="container services-module-mobile">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <h2 style="text-align: center;">Our Virtual Marketing Assistants Can Help <br>Your Business
                            Become More Efficient</h2>
                        <p class="text-center tiles-title-sub">{{ env('APP_NAME') }}'s digital Marketing Assistant services provide a
                            variety of AI-empowered solutions, including:</p>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div id="tiles-accordian" class="row">
                            <div class="tile col-md-12">
                                <div class="tile-header" id="heading-9801">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-center collapsed tiles-btn"
                                                data-toggle="collapse" data-target="#collapse-9801"
                                                aria-expanded="false" aria-controls="collapse-9801">
                                            <span>Content</span>
                                        </button>
                                    </h5>
                                </div>
                            </div>
                            <div id="collapse-9801" class="collapse" aria-labelledby="heading-9801"
                                 data-parent="#tiles-accordian">
                                <div class="tile-body text-center">
                                    <span class="tile-icon caption-icon"><i class="fa-classic fa-thin fa-newspaper"
                                                                            aria-hidden="true"></i></span><br>
                                    <p class="caption-body"></p>
                                    <div class="bullet-container">
                                        <div class="bullet-left">
                                            <ul class="list">
                                                <li>Developing, implementing and managing social media strategies</li>
                                                <li>Creating email templates and managing subscriber lists</li>
                                                <li>Collaborating with cross functional teams to create, manage and
                                                    publish high-quality content (Copywriters, Designers,
                                                    Sales/Marketing, Product/Development Teams)
                                                </li>
                                                <li>Developing and managing a monthly content calendar</li>
                                                <li>Designing eye-catching graphics for your brand using Canva</li>
                                            </ul>
                                        </div>
                                        <div class="bullet-right">
                                            <ul class="list">
                                                <li>Creating paid ad placements and tracking their ROI</li>
                                                <li>Using metrics—enhanced by AI tools—to hone and maximize the content
                                                    that resonates
                                                </li>
                                                <li>Organizing brand assets, photography and graphics used for social
                                                    initiatives
                                                </li>
                                                <li>Monitoring current social media trends</li>
                                                <li>Crafting impactful copy for social posts, ads, emails, and more</li>
                                                <li>Developing lead magnets to attract clients</li>
                                                <li>Editing audio and video for engaging social content</li>
                                            </ul>
                                        </div>
                                        <div class="bullet-mobile">
                                            <ul class="list">
                                                ...
                                                <li>Designing eye-catching graphics for your brand using Canva</li>
                                                <li>Creating paid ad placements and tracking their ROI</li>
                                                <li>Using metrics to&nbsp;hone and maximize&nbsp;the content that
                                                    resonates
                                                </li>
                                                <li>Organizing brand assets, photography and graphics used for social
                                                    initiatives
                            ...
                            <div class="tile col-md-12">
                                <div class="tile-header" id="heading-9802">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-center collapsed tiles-btn"
                                                data-toggle="collapse" data-target="#collapse-9802"
                                                aria-expanded="false" aria-controls="collapse-9802">
                                            <span>Brand Development</span>
                                        </button>
                                    </h5>
                                </div>
                            </div>
                            <div id="collapse-9802" class="collapse" aria-labelledby="heading-9802"
                                 data-parent="#tiles-accordian">
                                <div class="tile-body text-center">
                                    <span class="tile-icon caption-icon"><i class="fa-classic fa-thin fa-toolbox"
                                                                            aria-hidden="true"></i></span><br>
                                    <p class="caption-body"></p>
                                    <div class="bullet-container">
                                        <div class="bullet-left">
                                            <ul class="list">
                                                <li>Conducting audience and buyer persona research</li>
                                                <li>Establishing and/or reinforcing brand voice and social media
                                                    identity
                                                </li>
                                                <li>Building an online community by increasing followers and
                                                    engagement
                                                </li>
                                                <li>Facilitating client-company communication including responding to
                                                    queries, asking for reviews, and organizing chats and Q&amp;A
                                                    sessions
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="bullet-right">
                                            <ul class="list">
                                                <li>Joining groups and thought leadership threads and positioning brand
                                                    or leader as an expert in their field
                                                </li>
                                                <li>Networking with industry professionals</li>
                                                <li>Initiating conversations with industry leaders on social feeds</li>
                                                <li>Leveraging social media channels—using AI-enhanced insights—to
                                                    promote events and initiatives
                                                </li>
                                                <li>Handling commenting and direct messaging across all social
                                                    channels
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="bullet-mobile">
                                            <ul class="list">
                                                ...
                                                <li>Joining groups and thoughts leadership threads and positioning brand
                                                    or leader as an expert in their field
                                                </li>
                                                <li>Networking with industry professionals</li>
                                                <li>Initiating conversations with industry leaders on social feeds</li>
                                                <li>Leveraging social media channels to promote events and initiatives
                                                </li>
                                                <li>Handling commenting and direct messaging across all social
                                                    channels
                                                </li>
                            ...
                            <div class="tile col-md-12">
                                <div class="tile-header" id="heading-9803">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-center collapsed tiles-btn"
                                                data-toggle="collapse" data-target="#collapse-9803"
                                                aria-expanded="false" aria-controls="collapse-9803">
                                            <span>Analysis</span>
                                        </button>
                                    </h5>
                                </div>
                            </div>
                            <div id="collapse-9803" class="collapse" aria-labelledby="heading-9803"
                                 data-parent="#tiles-accordian">
                                <div class="tile-body text-center">
                                    <span class="tile-icon caption-icon"><i
                                            class="fa-classic fa-thin fa-magnifying-glass-chart" aria-hidden="true"></i></span><br>
                                    <p class="caption-body"></p>
                                    <div class="bullet-container">
                                        <div class="bullet-left">
                                            <ul class="list">
                                                <li>Defining important social media KPIs for your goals (ex:
                                                    distinguishing ‘Vanity Metrics’ from early adoption of social media
                                                    and technology)
                                                </li>
                                                <li>Setting and achieving actionable metrics</li>
                                                <li>Performing content optimization</li>
                                                <li>Monitoring brand mentions</li>
                                                <li>Assisting in social media audience analysis</li>
                                            </ul>
                                        </div>
                                        <div class="bullet-right">
                                            <ul class="list">
                                                <li>Conducting competitive analysis</li>
                                                <li>Measuring success of social media campaigns (organic and/or paid)
                                                </li>
                                                <li>Preparing weekly, monthly, and quarterly reports</li>
                                                <li>Researching, finding, and leveraging AI-powered measurement tools to
                                                    provide progress reports and mine insights
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="bullet-mobile">
                                            <ul class="list">
                                                ...
                                                <li>Preparing weekly, monthly, and quarterly reports</li>
                                                <li>Researching, finding and leveraging measurement tools to provide
                                                    progress reports and mine insights
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container services-module-desktop">
                <div class="row title-row">
                    <div class="col-12">
                        ...
                        <h2 style="text-align: center;">Our Virtual Marketing Assistants Can Help <br>Your Business
                            Become More Efficient</h2>
                        <p>{{ env('APP_NAME') }}'s digital Marketing Assistant services provide a variety of AI-empowered solutions,
                            including:</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        ...
                        <button class="btn service-btn selected" id="btn-1">Content</button>
                        <button class="btn service-btn " id="btn-2">Brand Development</button>
                        <button class="btn service-btn " id="btn-3">Analysis</button>
                    </div>
                    <div class="col-8">
                            ...
                            <div class="bullet-container">
                                <div class="bullet-left">
                                    <ul class="list">
                                        <li>Developing, implementing and managing social media strategies</li>
                                        <li>Creating email templates and managing subscriber lists</li>
                                        <li>Collaborating with cross functional teams to create, manage and publish
                                            high-quality content (Copywriters, Designers, Sales/Marketing,
                                ...
                                <div class="bullet-right">
                                    <ul class="list">
                                        <li>Creating paid ad placements and tracking their ROI</li>
                                        <li>Using metrics—enhanced by AI tools—to hone and maximize the content that
                                            resonates
                                        </li>
                                        <li>Organizing brand assets, photography and graphics used for social
                                            initiatives
                                ...
                                <div class="bullet-mobile">
                                    <ul class="list">
                                        ...
                                        <li>Designing eye-catching graphics for your brand using Canva</li>
                                        <li>Creating paid ad placements and tracking their ROI</li>
                                        <li>Using metrics to&nbsp;hone and maximize&nbsp;the content that resonates</li>
                                        <li>Organizing brand assets, photography and graphics used for social
                                            initiatives
                                        </li>
                                        <li>Monitoring current social media trends</li>
                        ...
                        <div class="content service-content active" id="content-2" style="width: 776.656px;">
                            ...
                            <div class="bullet-container">
                                <div class="bullet-left">
                                    <ul class="list">
                                        <li>Conducting audience and buyer persona research</li>
                                        <li>Establishing and/or reinforcing brand voice and social media identity</li>
                                        <li>Building an online community by increasing followers and engagement</li>
                                        <li>Facilitating client-company communication including responding to queries,
                                            asking for reviews, and organizing chats and Q&amp;A sessions
                                        </li>
                                    </ul>
                                </div>
                                <div class="bullet-right">
                                    <ul class="list">
                                        <li>Joining groups and thought leadership threads and positioning brand or
                                            leader as an expert in their field
                                        </li>
                                        <li>Networking with industry professionals</li>
                                        <li>Initiating conversations with industry leaders on social feeds</li>
                                        <li>Leveraging social media channels—using AI-enhanced insights—to promote
                                            events and initiatives
                                        </li>
                                        <li>Handling commenting and direct messaging across all social channels</li>
                                    </ul>
                                </div>
                                <div class="bullet-mobile">
                                    <ul class="list">
                                        ...
                                        <li>Joining groups and thoughts leadership threads and positioning brand or
                                            leader as an expert in their field
                                        </li>
                                        <li>Networking with industry professionals</li>
                                        <li>Initiating conversations with industry leaders on social feeds</li>
                                        <li>Leveraging social media channels to promote events and initiatives</li>
                                        <li>Handling commenting and direct messaging across all social channels</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="content service-content active" id="content-3" style="width: 776.656px;">
                            <!-- Content for button 1 -->
                            <span class="tile-icon caption-icon"><i class="fa-classic fa-thin fa-magnifying-glass-chart"
                                                                    aria-hidden="true"></i></span>
                            <!-- Font awesome icon -->
                            <p></p>
                            <div class="bullet-container">
                                <div class="bullet-left">
                                    <ul class="list">
                                        <li>Defining important social media KPIs for your goals (ex: distinguishing
                                            ‘Vanity Metrics’ from early adoption of social media and technology)
                                        </li>
                                        <li>Setting and achieving actionable metrics</li>
                                        <li>Performing content optimization</li>
                                        <li>Monitoring brand mentions</li>
                                ...
                                <div class="bullet-right">
                                    <ul class="list">
                                        <li>Conducting competitive analysis</li>
                                        <li>Measuring success of social media campaigns (organic and/or paid)</li>
                                        <li>Preparing weekly, monthly, and quarterly reports</li>
                                        <li>Researching, finding, and leveraging AI-powered measurement tools to provide
                                            progress reports and mine insights
                                        </li>
                                    </ul>
                                </div>
                                <div class="bullet-mobile">
                                    <ul class="list">
                                        ...
                                        <li>Measuring success of social media campaigns (organic and/or paid)</li>
                                        <li>Preparing weekly, monthly, and quarterly reports</li>
                                        <li>Researching, finding and leveraging measurement tools to provide progress
                                            reports and mine insights
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row d-flex flex-row justify-content-center">
                    <div class="col-sm-6 text-left">
                        <h2 class="text-left">AI-Amplified Execution.<br>Human-Led Strategy.</h2>
                        <p>Content demands consistency. Strategy demands clarity. And your schedule? Doesn’t allow for
                            either.<br><br>{{ env('APP_NAME') }}’s U.S.-based Marketing Assistants bring the structure, creativity, and
                            intelligence to help your brand show up on the right channels — at the right time.<br><br>Through
                            AI-empowered systems and workflows, they can quickly turn ideas into campaigns, maintain
                            your content calendar, draft and repurpose assets, and report on performance — all while
                            staying aligned to your tone and goals.<br><br>This is not generic automation.<br><br>It’s
                            marketing execution refined by AI, and led by a real person who understands your business,
        ...
        <section id="Two Column Content Section Title" class="two-column-content" style="background-color:#ffffff ">
            <div class="container">
                <div class="row u-fade-type-down js-scroll-trigger is-active">
                    <div class="col-lg-12">
                        <h2 class="text-left">You can make the most of your marketing – and we can help.</h2>
                    </div>
                </div>
                <div class="row u-fade-type-down js-scroll-trigger is-active">
                    <div class="col-lg-6">
                        <p></p>
                        <p>Once upon a time, marketing was as simple as a Tweet here, a follow there, and some icons in
                            the footer of your website and email.</p>
                        <p>Set it and forget it, right? Not anymore.</p>
                        <p>Social Media is only part of what you should be doing to get the most out of your marketing —
                            especially if you want your organization to grow.</p>
                        <p>Need a plan to identify your ideal audience? You need a Marketing Assistant — one empowered
                            with AI-driven insights to help you reach the right people, faster.</p>
                        <p>Want monthly analysis and feedback on how your message is reaching your customers and
                            prospects? You got it.</p>
                        <p></p>
                    </div>
                    <div class="col-lg-6">
                        <p></p>
                        <p>Are you stressed by those menacing red-badge notifications as customers and prospects engage
                            with you online? Your Marketing Assistant is standing by to help!</p>
                        <p>Better still, by leveraging AI, our Marketing Assistant services can now get even more done
                            for you every month — maximizing their time and your return on investment.</p>
                        <p>Let a {{ env('APP_NAME') }} Marketing Assistant manage your unique advertising needs. We understand that your
                            marketing routines may be varied, extensive, and exhaustive. Build a strong online presence
                            so you can focus on what you love most: running and growing your organization.</p>
                        <p></p>
                    </div>
                </div>
                <div class="row call-to-action-row u-fade-type-down js-scroll-trigger">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <a class="btn" href="{{ route('get_started') }}"><span>Hire a {{ env('APP_NAME') }} Marketing Assistant</span></a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-4 left-column">
                        <h2 class="text-left"> How can remote Marketing Assistant services help?</h2>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-8 right-column layout-3">
                        <div class="boxed-column">
                            <div class="boxed-column-inner gradient-icon-parent layout-center">
                                <i class="fa-thin fa-calendar-check"></i>
                                <h3>Create Content Calendars</h3>
                            </div>
                        </div>
                        <div class="boxed-column">
                            <div class="boxed-column-inner gradient-icon-parent layout-center">
                        ...
                        <div class="boxed-column">
                            <div class="boxed-column-inner gradient-icon-parent layout-center">
                                <i class="fa-thin fa-chess-bishop-piece"></i>
                        ...
                        <div class="boxed-column">
                            <div class="boxed-column-inner gradient-icon-parent layout-center">
                                ...
                                <h3>Create Brand Conversations</h3>
                            </div>
                        </div>
                        <div class="boxed-column">
                            <div class="boxed-column-inner gradient-icon-parent layout-center">
                                <i class="fa-thin fa-chart-line"></i>
                                <h3>Provide Analytic Reports</h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<style type="text/css">
	...
	c1.9,2,3,4.6,3,7.3S334.7,330.1,332.9,332.1z"></path>
        ...
        <section id="Banner Simple Section Title" class="banner-simple" style="background-color: ">
            <div class="container">
                <div class="row d-flex flex-column justify-content-center u-fade-type-down js-scroll-trigger">
                    <div class="col-lg-12">
                        <h2 class="text-center">Who can use Virtual Marketing Assistant Services?</h2>
                    </div>
                </div>
                <div class="row middle-row u-fade-type-down js-scroll-trigger">
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <p class="text-center">Executives<br>Small Businesses<br>Church Leaders</p>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <p class="text-center">Sales Teams<br>Managers<br>Consultants</p>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <p class="text-center">Entrepreneurs<br>Marketing Teams<br>Authors</p>
                    </div>
                </div>
                <div class="row d-flex flex-column justify-content-center u-fade-type-down js-scroll-trigger">
                    <div class="col-lg-12">
                        <h4 class="text-center">And you, probably!</h4>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="fine-or-great" class="talk-to-sales-banner" style="background: #4ce5e1;">
            <div class="container">
                <div class="row d-flex flex-row justify-content-center">
                    <div class="col-sm-6 text-left">
                        <h2 class="text-left"></h2>
                        <h2 style="text-align: left;">Sure, you’re probably managing your marketing just fine. But what
                            if it could be great?</h2>
                        <p>Contact us today to discover how you can reclaim your time, focus on what matters, and
                            achieve the growth you deserve.</p>
                    </div>
                    <div class="col-sm-6 text-right d-flex flex-column justify-content-center">
                        <div class="outter-button d-flex flex-row justify-content-end">
                            <a class="btn u-fade-type-down js-scroll-trigger"
                               href="https://resources.belaysolutions.com/rise-up-and-lead-well">Hire {{ env('APP_NAME') }}<i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-5 left-column">
                        <h2 class="text-left"></h2>
                        <h2 style="text-align: left;">FAQs About Digital Marketing Assistants</h2>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-7 right-column">
                        <div id="faq-accordion">
                            <div class="card">
                                <div class="card-header" id="heading-6591">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6591" aria-expanded="false"
                                                aria-controls="collapse-6591">
                                            <span>I’m new to the remote concept and have no idea how this will work for me. Is there help?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6591" class="collapse" aria-labelledby="heading-6591"
                                    ...
                                    <div class="card-body">
                                        <p>Of course! You’ll be assigned a Client Success Consultant who will walk
                                            ...
                                            your entire time here at {{ env('APP_NAME') }}. We want you to feel confident with our
                                            digital marketing assistant services.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6592">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6592" aria-expanded="false"
                                                aria-controls="collapse-6592">
                                            <span>What security measures are in place to protect us?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6592" class="collapse" aria-labelledby="heading-6592"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>All our contractors sign a Confidentiality Agreement to protect you and your
                                            organization. If you would like any additional contracts, then we can
                                            discuss that. We highly recommend strong passwords and using a password
                                            manager to keep your accounts secure.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6593">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6593" aria-expanded="false"
                                                aria-controls="collapse-6593">
                                            <span>How long does it take for me to be matched?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6593" class="collapse" aria-labelledby="heading-6593"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header" id="heading-6594">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6594" aria-expanded="false"
                                                aria-controls="collapse-6594">
                                            <span>Will I be able to interview the candidate you pick for me?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6594" class="collapse" aria-labelledby="heading-6594"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>We get it. Handing over the decision on who will work with you is a tough
                                            ...
                                            proven system to match you to someone equipped to handle everything you need
                                            to accomplish.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6595">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6595" aria-expanded="false"
                                                aria-controls="collapse-6595">
                                            <span>Can I talk to my Marketing Assistant?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6595" class="collapse" aria-labelledby="heading-6595"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>Of course! We want your Marketing Assistant to be an engaged member of your
                                            team!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6596">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6596" aria-expanded="false"
                                                aria-controls="collapse-6596">
                                            <span>I only need part of this Marketing Assistant service (i.e. account creation only). Is there an hourly rate for that?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6596" class="collapse" aria-labelledby="heading-6596"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p> No, we only offer a full-service solution and flat-rate pricing.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6597">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6597" aria-expanded="false"
                                                aria-controls="collapse-6597">
                                            <span>Do I get a team of Marketing Assistants that rotate?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6597" class="collapse" aria-labelledby="heading-6597"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>No, you will have one dedicated Marketing Assistant that we match you with
                                            based on your needs, industry, personality and working style.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-6598">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6598" aria-expanded="false"
                                                aria-controls="collapse-6598">
                                            <span>What happens if the Marketing Assistant and I don’t work well together?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6598" class="collapse" aria-labelledby="heading-6598"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header" id="heading-6599">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-6599" aria-expanded="false"
                                                aria-controls="collapse-6599">
                                            <span>Can my Marketing Assistant use AI?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-6599" class="collapse" aria-labelledby="heading-6599"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>Absolutely – in fact, we encourage it! Our clients and Marketing Assistant
                                            that leverage AI maximize productivity and increase efficiency to help them
                                            accomplish more and juggle less.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-65910">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-65910" aria-expanded="false"
                                                aria-controls="collapse-65910">
                                            <span>How does my Marketing Assistant account for the work done, as well as manage time off or vacation?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-65910" class="collapse" aria-labelledby="heading-65910"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>That will be between you and your Marketing Assistant. If there are times you
                                            know are slower, then let your Marketing Assistant know that would be a good
                                            time for time off. Commit to over-communicate with each other so work can be
                                            done ahead of time and productivity doesn’t lapse.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-65911">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-65911" aria-expanded="false"
                                                aria-controls="collapse-65911">
                                            <span>What if I don’t use all of my hours?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-65911" class="collapse" aria-labelledby="heading-65911"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>Your Marketing Assistant can ebb and flow your hours throughout the month. We
                                            just shoot to come in at the contracted amount at the end of the month. If
                                            they go over, we simply bill the extra hours, but they do not roll over to
                                            the next month. We track and report on those during onboarding to make sure
                                            you are at a good amount of hours for the work needed.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-65912">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-65912" aria-expanded="false"
                                                aria-controls="collapse-65912">
                                            <span>What if you do such a great job of matching me that I want to bring my Marketing Assistant onto my staff full-time?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-65912" class="collapse" aria-labelledby="heading-65912"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>It happens all the time! We know it’s a possibility that you’ll get to the
                                            place in your organization where you want to expand your W-2 team, and we
                                            love nothing more than knowing we helped you find your first (or second or
                                            fifth) hire. Talk to your Client Success Consultant about the details.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-65913">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-65913" aria-expanded="false"
                                                aria-controls="collapse-65913">
                                            <span>What if I need social media marketing assistant services?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-65913" class="collapse" aria-labelledby="heading-65913"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>You've come to the right place! We recruit professionals that are well-versed
                                            in being a social media marketing assistant. Whether you need assistance for
                                            a one-off social media campaign or are looking for ongoing social media
                                            management, our virtual digital marketing assistants are here to help.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="heading-65914">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link text-left" data-toggle="collapse"
                                                data-target="#collapse-65914" aria-expanded="false"
                                                aria-controls="collapse-65914">
                                            <span>What does the typical Marketing Assistant do for a client?</span>
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapse-65914" class="collapse" aria-labelledby="heading-65914"
                                     data-parent="#faq-accordion">
                                    <div class="card-body">
                                        <p>Your Marketing Assistant can handle your social channels, content creation,
                                            SMS and email marketing, podcast, webinar and course management, light
                                            graphic design, build a strong online presence, and more to help you grow
                                            your organization.</p>
                                    </div>
                                </div>
                            </div>
