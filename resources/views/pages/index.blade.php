            ...
            <div class="row d-flex flex-row text-center justify-content-center">
                ...
                <div class="col-sm-6 text-left d-flex flex-column justify-content-center image-list">
                    <div class="row d-flex flex-row text-left justify-content-center transform-list-block"
                         id="transformed-block-1">
                        <div id="transformed-image-1" class="col-sm-5 transformed-image"></div>
                        <p class="col-sm-7 transformed-text">Feel like you can't take a vacation? </p>
                    </div>
                    <div class="row d-flex flex-row text-left justify-content-center transform-list-block"
                         id="transformed-block-2">
                        <div id="transformed-image-2" class="col-sm-5 transformed-image"></div>
                        <p class="col-sm-7 transformed-text">Find yourself being busy instead of productive?</p>
                    </div>
                    <div class="row d-flex flex-row text-left justify-content-center transform-list-block"
                         id="transformed-block-3">
                        <div id="transformed-image-3" class="col-sm-5 transformed-image"></div>
                        <p class="col-sm-7 transformed-text">Losing hours of your day to email? </p>
                    </div>
                    <div class="row d-flex flex-row text-left justify-content-center transform-list-block"
                         id="transformed-block-4">
                        <div id="transformed-image-4" class="col-sm-5 transformed-image"></div>
                        <p class="col-sm-7 transformed-text">Feeling like your days are out of control?</p>
                    </div>
                </div>
            </div>
            <div class="row call-to-action-row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <a class="btn" href="#learnmore"><span>Learn More</span><i class="bi bi-chevron-down"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row d-flex flex-row justify-content-center">
                <div class="col-sm-6 text-left">
                    ...
                    <ul style="list-style-position: outside;">
                        ...
                        <li style="color: #ffffff;"><span
                                style="font-weight: 700; color: #ffffff;">Strategic Talent:</span> Intentionally-matched
                            Professionals based on psychographics and role demands, vetted for initiative, adaptability,
                            and AI fluency.
                        </li>
                        <li style="color: #ffffff;"><span
                                style="font-weight: 700; color: #ffffff;">Enduring Expertise:</span> In a world of
                            constant change, insight and experience are still your greatest advantage.
                        </li>
                        <li style="color: #ffffff;"><span
                ...
                <div class="col-sm-6 text-right d-flex flex-column justify-content-center">
                    <div class="outter-button d-flex flex-row justify-content-end">
                        <a class="btn" href="artificial-intelligence/index.html">LEARN MORE<i
...
<style type="text/css">
    ...
    <section id="book-release-boxed-section-title" class="book-release-boxed">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 left-column d-flex justify-content-center">
                    <h5 class="text-left">Introducing</h5>
                    <h2 class="text-left">Delegate to Elevate</h2>
                    <h3 class="text-left">Accomplish More By Juggling Less</h3>
                    <p class="text-left">When it comes to experiencing growth in your business, you have to think
                        differently about how you run it. You canʼt keep doing everything on your own; you have to
                        delegate. This ebook tells you how.</p>
                    <a class="btn" href="https://resources.belaysolutions.com/delegate-to-elevate"
                       target="_blank"><span>Learn More</span></a>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-6 right-column d-flex justify-content-center">
                    <p class="text-center d-flex justify-content-center">
                        <picture>
                            <source type="image/webp"
                                    srcset="https://belaysolutions.com/wp-content/uploads/2023/02/Delegate-To-Elevate-Icon.png.webp"/>
                            <img src="wp-content/uploads/2023/02/Delegate-To-Elevate-Icon.png"
                                 alt="Delegate to Elevate"/>
                        </picture>
                    </p>
                </div>
            </div>
    ...
    <section id="editable-stat-container" class="editable_stat" style="background-color: ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="stat_header">Your Path to Productivity Has Never Been Easier</h2>
                </div>
            </div>
            <div class="row stat-row">
                <div class="col-sm-12 col-md-6 col-lg-6 stat-column">
                    <h4 class="text-center stat-header">10,000+</h4>
                    <img src="wp-content/uploads/2023/05/knot-bar-divider.svg" alt="divider" class="stat_image"/>
                    <p class="stat-paragraph">Happy Clients Served</p>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 stat-column">
                    <h4 class="text-center stat-header">1 week</h4>
                    <img src="wp-content/uploads/2023/05/knot-bar-divider.svg" alt="divider" class="stat_image"/>
                    <p class="stat-paragraph">Average Time For Placement</p>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 stat-column">
                    <h4 class="text-center stat-header">93%</h4>
                    <img src="wp-content/uploads/2023/05/knot-bar-divider.svg" alt="divider" class="stat_image"/>
                    <p class="stat-paragraph">First Match Success Rate</p>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 stat-column">
                    <h4 class="text-center stat-header">2,000+</h4>
                    <img src="wp-content/uploads/2023/05/knot-bar-divider.svg" alt="divider" class="stat_image"/>
                    <p class="stat-paragraph">AI-Empowered Professionals at the Ready</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="awards-slider-section-title" class="awards-boxed" style="background-color:;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center left-column">
                    <h4 class="text-center">Awards, Recognition & Fanfare:</h4>
                </div>
                <div class="col-lg-12 awards-flexslider">
                    <ul class="slides">
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left"><img
                                        src="wp-content/uploads/2024/12/2024-Inc.-Best-In-Business-_Standard-Logo.png"
                                        alt=""/></p>
                                <h5 class="text-left">Inc. Best in Business 2024</h5>
                                <a href="https://www.inc.com/best-in-business" target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2022/08/Inc.-5000-Color-Medallion-Logo.png.webp"/>
                                        <img src="wp-content/uploads/2022/08/Inc.-5000-Color-Medallion-Logo.png"
                                             alt="Inc. 5000 America&#039;s Fastest-Growing Private Companies"/>
                                    </picture>
                                </p>
                                <h5 class="text-left">Fastest-Growing Private Companies</h5>
                                <a href="https://www.newswire.com/news/belay-celebrates-10-consecutive-years-on-the-inc-5000-annual-list-of-22402450"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2024/01/IMG_2281.png.webp"/>
                                        <img src="wp-content/uploads/2024/01/IMG_2281.png"
                                             alt="FlexJobs 2024 Top 100 Remote Work Companies to Watch"/>
                                    </picture>
                                </p>
                                <h5 class="text-left">FlexJobs Top 100 Companies to Watch for Remote Jobs in 2024</h5>
                                <a href="https://www.flexjobs.com/blog/post/100-top-companies-with-remote-jobs-in-2024/"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2022/04/Inc-Black-768x266-1.png.webp"/>
                                        <img src="wp-content/uploads/2022/04/Inc-Black-768x266-1.png"
                                             alt="Inc Advocates For Small Business"/>
                                    </picture>
                                </p>
                                <h5 class="text-left">Advocates for Small Business</h5>
                                <a href="https://www.inc.com/profile/belay" target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2022/04/inc-best-workplace-logo.png.webp"/>
                                        <img src="wp-content/uploads/2022/04/inc-best-workplace-logo.png"
                                             alt="Inc. 2020 Best Workplaces"/>
                                    </picture>
                                </p>
                                <h5 class="text-left">Awarding Excellence in Company Culture</h5>
                                <a href="https://www.newswire.com/news/belay-ranked-in-inc-magazines-annual-list-of-best-workplaces-for-2020-21140607"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left"><img
                                        src="wp-content/uploads/2022/04/1413842503-entrepreneur-logo.png.webp"
                                        alt="Entrepreneur"/></p>
                                <h5 class="text-left">Everything Small Business</h5>
                                <a href="https://www.prnewswire.com/news-releases/belay-ranked-1-among-small-companies-in-the-2017-top-company-cultures-list-presented-by-entrepreneur-and-cultureiq-300410130.html"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left"><img src="wp-content/uploads/2022/04/EntreLeadership.png.webp"
                                                          alt="EntreLeadership"/></p>
                                <h5 class="text-left">Real Leadership Starts Here</h5>
                                <a href="https://www.ramseysolutions.com/shows/the-entreleadership-podcast"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2022/04/eo-fire-logo.jpg.webp"/>
                                        <img src="wp-content/uploads/2022/04/eo-fire-logo.jpg" alt="EO Fire"/>
                                    </picture>
                                </p>
                                <h5 class="text-left">Entrepreneurs Inspiring Entrepreneurs</h5>
                                <a href="https://www.eofire.com/podcast/bryanandshannonmiles/" target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="wp-content/uploads/2022/04/VAA-Tested_smaller.png.webp"/>
                                        <img src="wp-content/uploads/2022/04/VAA-Tested_smaller.png" alt=""/>
                                    </picture>
                                </p>
                                <h5 class="text-left">Honest Virtual Assistant Reviews</h5>
                                <a href="https://www.virtualassistantassistant.com/belay" target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                <p class="text-left"><img
                                        src="wp-content/uploads/2022/04/michael-myatt-logo-greyscale.png"
                                        alt="Michael Hyatt & Co."/></p>
                                <h5 class="text-left">Win at Work. Succeed at Life.</h5>
                                <a href="https://fullfocus.co/my-experience-using-a-virtual-assistant/"
                                   target="_blank"></a>
                            </div>
                        </li>
                        <li class="award-slide">
                            <div class="inner-container">
                                ...
                                <a href="https://www.cardrates.com/news/belay-recognized-for-helping-businesses-scale-up/"
                                   target="_blank"></a>
                            </div>
                        </li>
                    </ul>
    ...
    <section id="brands-grid-boxed-section-title" class="brands-grid-boxed" style="background-color: ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-3 d-flex flex-column justify-content-center logo-block">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 d-flex flex-column justify-content-center logo-block">
                    <img src="wp-content/uploads/2022/04/michael-myatt-logo-greyscale.png" alt="Michael Hyatt & Co."/>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 d-flex flex-column justify-content-center logo-block">
